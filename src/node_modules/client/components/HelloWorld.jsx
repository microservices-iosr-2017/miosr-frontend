...
import ExampleStore from 'client/stores/ExampleStore';
...
export default class HelloWorld extends React.Component {
  ...
  componentDidMount() {
    ExampleStore.listen(this.onStoreChanged);

    ExampleActions.fetchExample();
  }

  componentWillUnmount() {
    ExampleStore.unlisten(this.onStoreChanged);
  }
