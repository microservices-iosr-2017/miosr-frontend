...
class AppStore {
  ...
  onLogin({username, password}) {
    this._axios.post(LOGIN_URL, {username, password})
      .then(response => {
...
export default function build({altInstance, axios, appActions}) {
  return altInstance.createStore(AppStore, 'AppStore', axios, appActions);
}
