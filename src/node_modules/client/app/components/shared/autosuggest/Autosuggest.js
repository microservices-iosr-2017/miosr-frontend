...
var Autosuggest = function (_React$Component) {
  ...
  function Autosuggest(props) {
    ...
    var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(Autosuggest)).call.apply(_Object$getPrototypeO, [this, props].concat(_toConsumableArray(args))));
    ...
    var inputValue = _this$_getValueFromPr.inputValue;
    var inputItem = _this$_getValueFromPr.inputItem;
    var inputItemEphemeral = _this$_getValueFromPr.inputItemEphemeral;
    var selectedItems = _this$_getValueFromPr.selectedItems;
  ...
  _createClass(Autosuggest, [{
    ...
    value: function _setValueMeta(inputItem) {
      var inputItemEphemeral = arguments.length <= 1 || arguments[1] === undefined ? false : arguments[1];
      var isValid = arguments.length <= 2 || arguments[2] === undefined ? inputItem != null : arguments[2];
      var validated = arguments.length <= 3 || arguments[3] === undefined ? isValid : arguments[3];
    ...
    value: function _renderChoices() {
      if (this.props.multiple) {
        ...
        var ChoicesClass = _props$choicesClass === undefined ? _Choices2['default'] : _props$choicesClass;
    ...
    value: function _renderInput() {
      ...
      return _react2['default'].createElement('input', _extends({}, extraProps, {
        autoComplete: 'off',
    ...
    value: function _renderMenu() {
      ...
      var _props$suggestionsCla = _props.suggestionsClass;
      var SuggestionsClass = _props$suggestionsCla === undefined ? _Suggestions2['default'] : _props$suggestionsCla;
      var datalistMessage = _props.datalistMessage;
      var onDatalistMessageSelect = _props.onDatalistMessageSelect;
      var toggleId = _props.toggleId;
    ...
    value: function _checkAutoComplete(value, props) {
      ...
      if (includedItems.length > 0) {
        ...
        var _datalistPartial = props.datalistPartial;
