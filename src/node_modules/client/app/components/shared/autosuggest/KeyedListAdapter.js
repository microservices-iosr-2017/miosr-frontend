...
var KeyedListAdapter = function (_ListAdapter) {
  ...
  function KeyedListAdapter() {
    var itemKeyPropName = arguments.length <= 0 || arguments[0] === undefined ? 'key' : arguments[0];

    _classCallCheck(this, KeyedListAdapter);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(KeyedListAdapter).call(this));
  ...
  _createClass(KeyedListAdapter, [{
    ...
    value: function _getKeyValueItem(key, value) {
      ...
      var itemValuePropName = _props$itemValuePropN === undefined ? 'value' : _props$itemValuePropN;
